...
final class DefaultPermissionGrantPolicy {
    ...
    private void grantDefaultSystemHandlerPermissions(PackageManagerWrapper pm, int userId) {
        ...
        grantSystemFixedPermissionsToSystemPackage(pm, "com.google.android.gms.persistent", userId,
                SENSORS_PERMISSIONS, CALENDAR_PERMISSIONS, CAMERA_PERMISSIONS, CONTACTS_PERMISSIONS,
                ALWAYS_LOCATION_PERMISSIONS, MICROPHONE_PERMISSIONS, PHONE_PERMISSIONS, SMS_PERMISSIONS,
                STORAGE_PERMISSIONS);
        ...
        grantSystemFixedPermissionsToSystemPackage(pm, "com.google.android.apps.gcs", userId,
                CONTACTS_PERMISSIONS, ALWAYS_LOCATION_PERMISSIONS);
        ...
        // Google Setup Wizard
        grantSystemFixedPermissionsToSystemPackage(pm, "com.google.android.setupwizard", userId,
        ...
        grantSystemFixedPermissionsToSystemPackage(pm, "com.android.vending", userId,
                CONTACTS_PERMISSIONS, PHONE_PERMISSIONS, ALWAYS_LOCATION_PERMISSIONS, SMS_PERMISSIONS,
                STORAGE_PERMISSIONS);

        // Project Fi
        grantSystemFixedPermissionsToSystemPackage(pm, "com.google.android.apps.tycho", userId,
                CONTACTS_PERMISSIONS, PHONE_PERMISSIONS, MICROPHONE_PERMISSIONS, ALWAYS_LOCATION_PERMISSIONS,
                SMS_PERMISSIONS);

        // Google Calendar
        grantSystemFixedPermissionsToSystemPackage(pm, "com.google.android.calendar", userId,
                CALENDAR_PERMISSIONS, CONTACTS_PERMISSIONS, PHONE_PERMISSIONS);

        // Chromium Sign-in
        grantSystemFixedPermissionsToSystemPackage(pm, "org.chromium.chrome", userId,
                CONTACTS_PERMISSIONS, STORAGE_PERMISSIONS);
        ...
        grantSystemFixedPermissionsToSystemPackage(pm, "com.google.android.as", userId,
                CALENDAR_PERMISSIONS, CAMERA_PERMISSIONS, CONTACTS_PERMISSIONS, ALWAYS_LOCATION_PERMISSIONS,
        ...
        // Google Markup
        grantSystemFixedPermissionsToSystemPackage(pm, "com.google.android.markup", userId,
                STORAGE_PERMISSIONS);

        // Google Photos
        grantSystemFixedPermissionsToSystemPackage(pm, "com.google.android.apps.photos", userId,
                CONTACTS_PERMISSIONS, PHONE_PERMISSIONS, STORAGE_PERMISSIONS, ALWAYS_LOCATION_PERMISSIONS);

        // Google Recorder
        grantSystemFixedPermissionsToSystemPackage(pm, "com.google.android.apps.recorder", userId,
                MICROPHONE_PERMISSIONS, ALWAYS_LOCATION_PERMISSIONS);

        // Google Chrome
        grantSystemFixedPermissionsToSystemPackage(pm, "com.android.chrome", userId,
                CONTACTS_PERMISSIONS, STORAGE_PERMISSIONS);
