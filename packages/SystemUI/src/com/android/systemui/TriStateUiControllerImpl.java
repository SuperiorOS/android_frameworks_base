...
import com.android.systemui.TriStateUiController;
import com.android.systemui.TriStateUiController.UserActivityListener;
...
public class TriStateUiControllerImpl implements ConfigurationListener, TriStateUiController {
    ...
    private void updateTheme(boolean force) {
        int theme = Settings.Secure.getInt(mContext.getContentResolver(), Settings.Secure.THEME_MODE, 0);
