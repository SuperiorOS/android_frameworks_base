...
package com.android.systemui.stag.header;
...
public class StatusBarHeaderMachine {
    ...
    public static final String STATUS_BAR_HEADER_UPDATE_ACTION = "com.android.systemui.stag.header.STATUS_BAR_HEADER_UPDATE";
