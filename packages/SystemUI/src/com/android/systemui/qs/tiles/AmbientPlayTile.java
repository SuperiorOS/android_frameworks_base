...
public class AmbientPlayTile extends QSTileImpl<BooleanState> {
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        state.value = enable;
        state.label = mContext.getString(R.string.quick_settings_ambient_play);
        if (enable) {
            state.icon = ResourceIcon.get(R.drawable.ic_qs_ambient_play_on);
            state.contentDescription =  mContext.getString(
                    R.string.quick_settings_ambient_play);
            state.state = Tile.STATE_ACTIVE;
        } else {
            state.icon = ResourceIcon.get(R.drawable.ic_qs_ambient_play_off);
            state.contentDescription =  mContext.getString(
                    R.string.quick_settings_ambient_play);
    ...
    public CharSequence getTileLabel() {
        return mContext.getString(R.string.quick_settings_ambient_play);
    }
