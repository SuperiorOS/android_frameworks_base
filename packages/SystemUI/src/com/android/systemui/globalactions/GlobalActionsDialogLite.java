...
public class GlobalActionsDialogLite implements DialogInterface.OnDismissListener,
    ...
    protected int getMaxShownPowerItems() {
        ...
        if (mIsRebootMenu) {
            ...
            // Sets in GlobalActionsLayoutLite as well.
            return 4;
    ...
    private Action getScreenrecordAction() {
        return new SinglePressAction(com.android.systemui.R.drawable.ic_lock_screenrecord,
            ...
            public void onPress() {
                mStatusBar.collapseShade();
                final ComponentName screenRecorderComponent =
                        new ComponentName("com.android.systemui",
                        "com.android.systemui.screenrecord.ScreenRecordDialog");
                final Intent screenRecordIntent = new Intent();
                screenRecordIntent.setComponent(screenRecorderComponent);
                screenRecordIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                mContext.startActivity(screenRecordIntent);
            }
