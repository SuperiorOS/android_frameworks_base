...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        public void update() {
            boolean mOldMobileType = Settings.System.getIntForUser(mContext.getContentResolver(),
    ...
    protected void makeStatusBarView(@Nullable RegisterStatusBarResult result) {
        ...
        filter.addAction(SuperiorUtils.ACTION_DISMISS_KEYGUARD);
    ...
    private final BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            } else if (SuperiorUtils.ACTION_DISMISS_KEYGUARD.equals(action)) {
                if (intent.hasExtra(SuperiorUtils.DISMISS_KEYGUARD_EXTRA_INTENT)) {
                    Intent launchIntent = (Intent) intent.getParcelableExtra(SuperiorUtils.DISMISS_KEYGUARD_EXTRA_INTENT);
