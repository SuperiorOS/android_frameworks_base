...
public class IDEClockController implements ClockPlugin {
    ...
    private void createViews() {
        ...
        mTime = mBigClockView.findViewById(R.id.clockTime);
        mDate = mBigClockView.findViewById(R.id.clockDate);
        mDay = mBigClockView.findViewById(R.id.clockDay);
        mMonth = mBigClockView.findViewById(R.id.clockMonth);
        mtextInclude = mBigClockView.findViewById(R.id.textInclude);
        mtextStd = mBigClockView.findViewById(R.id.textStd);
        mtextUsingNamespace = mBigClockView.findViewById(R.id.textUsingNamespace);
        mtextIntMain = mBigClockView.findViewById(R.id.textIntMain);
        mtextTimeDateDayMonth = mBigClockView.findViewById(R.id.textTimeDateDayMonth);
    }
