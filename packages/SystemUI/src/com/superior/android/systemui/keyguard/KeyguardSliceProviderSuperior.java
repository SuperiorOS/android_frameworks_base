package com.superior.android.systemui.keyguard;
...
public class KeyguardSliceProviderSuperior extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<KeyguardSliceProviderSuperior> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(KeyguardSliceProviderSuperior keyguardSliceProviderSuperior, SmartSpaceCard smartSpaceCard) {
            mProviderReference = new WeakReference<>(keyguardSliceProviderSuperior);
            mWeatherCard = smartSpaceCard;
            mBlurRadius = keyguardSliceProviderSuperior.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            KeyguardSliceProviderSuperior keyguardSliceProviderSuperior;
            synchronized (this) {
                mWeatherCard.setIcon(bitmap);
                keyguardSliceProviderSuperior = (KeyguardSliceProviderSuperior) mProviderReference.get();
            }
            if (keyguardSliceProviderSuperior != null) {
                keyguardSliceProviderSuperior.notifyChange();
            }
        }
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("KeyguardSliceProviderSuperior#onBindSlice");
        Slice slice;
